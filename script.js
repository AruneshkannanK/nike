...
function displayHomePage() {
  document.getElementById("content-area").innerHTML = `
    ...
    <div class="dont-miss">
       <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/w_1416,c_limit/1590482a-4d86-4a6e-bc09-4914eca511ee/nike-just-do-it.jpg">
        <div class="overlay-text">
           ...
           <div class="sport-carousel" id="sport-carousel">
              <div class="sport-carousel-items">
                   <div class="sport-carousel-item">
                       <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_432,c_limit/a3c971bc-bc0a-4c0c-8bdf-e807a3027e53/nike-just-do-it.jpg" alt="Running"/>
                        <h3>Running</h3>
                   </div>
                   <div class="sport-carousel-item">
                       <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_432,c_limit/e4695209-3f23-4a05-a9f9-d0edde31b653/nike-just-do-it.jpg" alt="Football"/>
                       <h3>Football</h3>
                 </div>
                   <div class="sport-carousel-item">
                       <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_432,c_limit/38ed4b8e-9cfc-4e66-9ddd-02a52314eed9/nike-just-do-it.jpg" alt="Basketball"/>
                        <h3>Basketball</h3>
                  </div>
               </div>
      ...
      <h2>Member Benefits</h2>
         <div class="member-items">
           <div class="member-item">
               <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_379,c_limit/cb28c551-b85b-479f-8fc3-40ad4e7c9ca4/nike-just-do-it.jpg" alt="Member Benefit 1"/>
                <div class="overlay-text">
           ...
           <div class="member-item">
               <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_379,c_limit/100ca749-1a94-4f98-bc43-a58e7e9cdbcf/nike-just-do-it.png" alt="Member Benefit 2"/>
              <div class="overlay-text">
                  <h3>Nike By You</h3>
          ...
          <div class="member-item">
                <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_379,c_limit/39412611-0af5-4770-8c2e-ef5c23bc6a3d/nike-just-do-it.jpg" alt="Member Benefit 3"/>
                 <div class="overlay-text">
 ...
 <br>
  ...
  <div class="products">
      <div class="product-card">
        <img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/h_379,c_limit/39412611-0af5-4770-8c2e-ef5c23bc6a3d/nike-just-do-it.jpg" alt="Shoe 1">
        <h3>Running Shoe</h3>
        <p>$100.00</p>
...
function submitLogin() {
  ...
  if (registeredUsers[username] && registeredUsers[username].password === password) {
      user = { username: username, email:registeredUsers[username].email };
...
function submitRegister() {
 ...
 // Validate username and password
  ...
  //    // Store user info (simulated database)
...
// Initial page load:  Load home page by default
